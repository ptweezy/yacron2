...
- `perf-chart.svg`, `perf-summary.md`, `perf-results.json`: the performance comparison against the previous release (see [Performance Benchmarks](Performance-Benchmarks); the chart is absent on the first release, which has no baseline)
